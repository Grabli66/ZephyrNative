			...
			switch (__temp_hash3)
			{
				...
				case -672261858:
				{
					...
					if (( (( ( __temp_hash3 == 104431 ) && __temp_svar1.equals("int") )) || __temp_svar1.equals("Integer") )) 
					{
						//line 75 "/usr/lib/haxe/std/java/_std/Type.hx"
						__temp_executeDef2 = false;
						//line 77 "/usr/lib/haxe/std/java/_std/Type.hx"
						return "Int";
					}
	...
	public static java.lang.Class resolveClass(java.lang.String name)
	{
		...
		catch (java.lang.ClassNotFoundException e)
		{
			...
			//line 103 "/usr/lib/haxe/std/java/_std/Type.hx"
			{
				...
				switch (__temp_svar1.hashCode())
				{
					case 360541844:
					{
						...
						if (__temp_svar1.equals("haxe.root.Class")) 
						{
							//line 103 "/usr/lib/haxe/std/java/_std/Type.hx"
							__temp_executeDef2 = false;
							//line 108 "/usr/lib/haxe/std/java/_std/Type.hx"
					...
					case -1242153355:
					{
						...
						if (__temp_svar1.equals("haxe.root.String")) 
						{
							//line 103 "/usr/lib/haxe/std/java/_std/Type.hx"
							__temp_executeDef2 = false;
							//line 106 "/usr/lib/haxe/std/java/_std/Type.hx"
					...
					case -140489125:
					{
						...
						if (__temp_svar1.equals("haxe.root.Dynamic")) 
						{
							//line 103 "/usr/lib/haxe/std/java/_std/Type.hx"
							__temp_executeDef2 = false;
							//line 109 "/usr/lib/haxe/std/java/_std/Type.hx"
					...
					case 704654956:
					{
						...
						if (__temp_svar1.equals("haxe.root.Math")) 
						{
							//line 103 "/usr/lib/haxe/std/java/_std/Type.hx"
							__temp_executeDef2 = false;
							//line 107 "/usr/lib/haxe/std/java/_std/Type.hx"
					...
					case 363325304:
					{
						...
						if (__temp_svar1.equals("haxe.root.Float")) 
						{
							//line 103 "/usr/lib/haxe/std/java/_std/Type.hx"
							__temp_executeDef2 = false;
							//line 105 "/usr/lib/haxe/std/java/_std/Type.hx"
							return double.class;
						}
					...
					case -1778387957:
					{
						...
						if (__temp_svar1.equals("haxe.root.Int")) 
						{
							//line 103 "/usr/lib/haxe/std/java/_std/Type.hx"
							__temp_executeDef2 = false;
							//line 104 "/usr/lib/haxe/std/java/_std/Type.hx"
							return int.class;
						}
				...
				//line 110 "/usr/lib/haxe/std/java/_std/Type.hx"
				if (__temp_executeDef2) 
				{
					//line 110 "/usr/lib/haxe/std/java/_std/Type.hx"
					return null;
	...
	public static <T> T createEmptyInstance(java.lang.Class cl)
	{
		...
		try 
		{
			...
			try 
			{
				...
				//line 254 "/usr/lib/haxe/std/java/_std/Type.hx"
			...
			{
				//line 256 "/usr/lib/haxe/std/java/_std/Type.hx"
