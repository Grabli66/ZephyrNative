...
public class ParamEnum extends haxe.lang.Enum
{
	...
	@Override public java.lang.String toString()
	{
		...
		//line 124 "/usr/lib/haxe/std/java/internal/HxObject.hx"
		ret.add(haxe.lang.Runtime.toString(")"));
	...
	@Override public boolean equals(java.lang.Object obj)
	{
		...
		//line 141 "/usr/lib/haxe/std/java/internal/HxObject.hx"
		{
			...
			while (( _g1 < _g ))
			{
				//line 141 "/usr/lib/haxe/std/java/internal/HxObject.hx"
				int i = _g1++;
				//line 143 "/usr/lib/haxe/std/java/internal/HxObject.hx"
		...
		//line 146 "/usr/lib/haxe/std/java/internal/HxObject.hx"
		return true;
	}
	...
	{
		//line 151 "/usr/lib/haxe/std/java/internal/HxObject.hx"
		int h = 19;
		...
		if (( this.params != null )) 
		{
			...
			while (( _g < ((java.lang.Object[]) (_g1) ).length ))
			{
				...
				//line 152 "/usr/lib/haxe/std/java/internal/HxObject.hx"
				 ++ _g;
				//line 154 "/usr/lib/haxe/std/java/internal/HxObject.hx"
				h *= 31;
		...
		//line 158 "/usr/lib/haxe/std/java/internal/HxObject.hx"
		h += this.index;
